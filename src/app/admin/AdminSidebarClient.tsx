    ...
    <div className="admin-layout-wrapper">
      ...
      <aside className={`admin-sidebar ${isOpen ? "open" : ""}`}>
        ...
        <nav className="admin-sidebar-nav">
          ...
          <a href="/admin/productos" className={`admin-nav-item ${pathname === "/admin/productos" ? "active" : ""}`}>
          ...
          <a href="/admin/descuentos" className={`admin-nav-item ${pathname === "/admin/descuentos" ? "active" : ""}`}>
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="19" y1="5" x2="5" y2="19"></line><circle cx="6.5" cy="6.5" r="2.5"></circle><circle cx="17.5" cy="17.5" r="2.5"></circle></svg>
            Descuentos
          </a>
          <a href="/admin/pedidos-camino" className={`admin-nav-item ${pathname === "/admin/pedidos-camino" ? "active" : ""}`}>
          ...
          <a href="/admin/clientes" className={`admin-nav-item ${pathname === "/admin/clientes" ? "active" : ""}`}>
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path><path d="M2 21v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2"></path><circle cx="8" cy="7" r="4"></circle></svg>
            Clientes
          </a>
          <a href="/admin/cotizaciones" className={`admin-nav-item ${pathname === "/admin/cotizaciones" ? "active" : ""}`}>
          ...
          <a href="/admin/configuracion" className={`admin-nav-item ${pathname === "/admin/configuracion" ? "active" : ""}`}>
        ...
        <div style={{ borderTop: "1px solid var(--admin-glass-border)", paddingTop: "15px", marginTop: "15px" }}>
